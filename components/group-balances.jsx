      ...
      <div className="text-center pb-4 border-b">
        ...
        {me.totalBalance !== 0 && (
          <p className="text-xs text-muted-foreground mt-2 max-w-md mx-auto">
            {me.totalBalance > 0
              ? `💡 After everyone settles up, you'll receive ${formatCurrency(Math.abs(me.totalBalance))} more than you spent`
              : `💡 After everyone settles up, you'll have paid ${formatCurrency(Math.abs(me.totalBalance))} more than your share`}
          </p>
        )}
      </div>
