      ...
      <div className="flex flex-wrap gap-2.5">
        {participants.map((participant) => (
          <Badge
            key={participant.id}
            variant="secondary"
            className="flex items-center gap-2 px-3.5 py-2.5 text-sm font-medium hover:bg-secondary/80 transition-colors"
          >
            ...
            {participant.id !== currentUser?._id && (
              <button
                ...
                className="ml-1 text-muted-foreground hover:text-destructive transition-colors p-0.5 rounded-full hover:bg-destructive/10"
              >
          ...
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="h-10 gap-2 text-sm font-medium border-2 border-dashed hover:border-primary hover:bg-primary/5 transition-all"
                type="button"
              >
